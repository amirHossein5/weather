...
Date.prototype.sunrise = function ({ lat, long, zenith }) {
    return this.sunriseSet(lat, long, true, zenith);
};

Date.prototype.sunset = function ({ lat, long, zenith }) {
    return this.sunriseSet(lat, long, false, zenith);
};
